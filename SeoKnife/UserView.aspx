<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserView.aspx.cs" Inherits="SeoKnife.UserView" %>
...
<head runat="server">
    ...
    <meta name="description" runat="server" id="description" />
            ...
            <br><br><div>
                ...
                <div class="questions-wrapper">
                    <div class="dwqa-container">                   
                        ...
                        </div><div class="dwqa-questions-list" style="text-align:center">
                            <asp:Image runat="server" ID="UserImage" ImageUrl="https://cdn2.iconfinder.com/data/icons/website-icons/512/User_Avatar-512.png" Width="150" CssClass="round-image"/>
                          
                            <h4 class="text-bold" style="font-family: mv boli;"><asp:Label runat="server" ID="UserName"></asp:Label></h4>
                                <asp:PlaceHolder runat="server" ID="SocialButtons"></asp:PlaceHolder>  
                         
                           
                                <asp:PlaceHolder runat="server" ID="UserInfoPlace"></asp:PlaceHolder>
